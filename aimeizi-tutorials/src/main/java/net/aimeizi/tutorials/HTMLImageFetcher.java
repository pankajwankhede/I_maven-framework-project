...
public class HTMLImageFetcher {
    ...
    protected final static String img_path = "target/";//下载后图片存放目录
    
    private final static String user_agent = "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:31.0) Gecko/20100101 Firefox/31.0";
    ...
    public static void main(String[] args) {
        String html = "这张图片很漂亮啊！"
                + "<img src='https://avatars3.githubusercontent.com/u/887836?v=1&s=460' alt='github'/>"//演示远程图片，抓取到本地，并修改为本地图片路径
                + "<img src='http://su.bdimg.com/static/superplus/img/logo_white.png' alt='baidu'/>"
                + " ，太帅了！<img src='/images/logo.gif' alt='oschina'/>";//本地图片，则不做处理
        ...
        for (int i = 0; i < imgs.size(); i++) {
            ...
            if (!src.startsWith("/")) {
                try {
                    ...
                    if (!imgHost.endsWith(".oschina.net")) {//排除域名为oschina.net的图片(如果图片地址中包含oschina.net，则不进行抓取)
