 ...
 * annotation-based.  The @Indexed annotation tells Hibernate Search to map it to a Lucene index.  The "interceptor" 
 * element sets up conditional indexing rules, to prevent instances from being indexed when the "active" flag is "false" 
 * (see the "com.packtpub.hibernatesearch.util.IndexWhenActiveInterceptor" class.
 */
