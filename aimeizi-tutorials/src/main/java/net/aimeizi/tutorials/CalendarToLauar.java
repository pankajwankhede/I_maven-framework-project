...
public class CalendarToLauar {
    ...
    public static void main(String[] args) {
        System.out.println(getLunar("2014", "8", "1"));//含天干地支的农历格式 (农历 【马】贰零壹肆 年 七月小初六 甲午年壬申月甲辰日)
        System.out.println(CalendarToLauar.getSimpleLunar("2014", "8", "1"));//简短的农历格式 (七月初六)
        System.out.println(SolarTerm.getSoralTerm(2014,8,7));//获取节气  (立秋)
    }
