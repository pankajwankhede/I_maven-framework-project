    ...
    <div id="detail">
        ...
        <script type="text/javascript">
            ...
            function loadPeople() {
                request("http://localhost:8080/people/", "GET", onPeopleLoaded);
            }

            function deletePerson() {
                var url = "http://localhost:8080/people/" + $("#detail .code").text();
            ...
            function fetchDetail() {
                var url = "http://localhost:8080/people/" + $(this).attr("id");
